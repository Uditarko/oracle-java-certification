...
public class FunctionalInterfacesExercise02 {
     ...
     * search criteria.
     * <p>
     * Use functional composition to create a Predicate. Check if each of the
     * fields in the search criteria is not null. Combine the different
     * predicates for each of the fields in the appropriate way - include a
     * predicate if the corresponding search criteria field is not null.
     *
     * @param criteria Search criteria.
     * @return A Predicate that returns true for products that match the
